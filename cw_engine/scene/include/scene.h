...
namespace Engine::Scene {
    ...
    public:
        ...
        [[nodiscard]] Engine::Graphics::OrthographicCamera &GetCamera() { return m_Camera; }
    ...
    private:
        ...
        void UpdateChildTransforms(uint32_t entityID, const glm::mat4 &parentGlobalTransform);
